...
//        //@formatter:on
  ...
  //
  // /**
  // * This test attempts to create an error after tasks have been submitted to the queue so that
  // they
  ...
  // }
  //
  // gaLogger.fine(String.format("Ignored = %d, Running = %d, Other = %d", ignored, running,
  // other));
  //
  // if (running <= set1) {
  // // Test not valid
  ...
  //
  // /**
  // * Test a failed connection disables. This is handled differently to any other IO exception so
  // has
  // * a separate test.
  // *
  // * @throws Exception the exception
  ...
  //
  // final ByteArrayOutputStream out = new ByteArrayOutputStream(1024);
  // final HttpURLConnection urlConnection = createHttpUrlConnection(HttpURLConnection.HTTP_OK,
  // out);
  //
