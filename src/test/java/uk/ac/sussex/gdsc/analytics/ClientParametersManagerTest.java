...
public class ClientParametersManagerTest {
  ...
  public void testGetPlatform() {
    ...
    Assertions.assertEquals("Windows NT 10.0",
        ClientParametersManager.getPlatform("WINDOWS server 2016"));
    ...
    Assertions.assertEquals("Windows NT 6.3",
        ClientParametersManager.getPlatform("WINDOWS server 2012 r2"));
    ...
    Assertions.assertEquals("Windows NT 6.2",
        ClientParametersManager.getPlatform("WINDOWS server 2012"));
    ...
    Assertions.assertEquals("Windows NT 6.1",
        ClientParametersManager.getPlatform("WINDOWS server 2011"));
    Assertions.assertEquals("Windows NT 6.1",
        ClientParametersManager.getPlatform("WINDOWS server 2008 r2"));
    ...
    Assertions.assertEquals("Windows NT 6.0",
        ClientParametersManager.getPlatform("WINDOWS server 2008"));
    Assertions.assertEquals("Windows NT 5.2",
        ClientParametersManager.getPlatform("WINDOWS server 2003"));
    Assertions.assertEquals("Windows NT 5.2",
        ClientParametersManager.getPlatform("WINDOWS xp x64"));
    ...
    Assertions.assertEquals("Windows NT 5.01",
        ClientParametersManager.getPlatform("WINDOWS 2000, service"));
    ...
    Assertions.assertEquals("Windows 98; Win 9x 4.90",
        ClientParametersManager.getPlatform("WINDOWS mw"));
    ...
    Assertions
        .assertTrue(ClientParametersManager.getPlatform("Linux and stuff").startsWith("Linux"));
    // This is untouched
    Assertions.assertTrue(
        ClientParametersManager.getPlatform("other platform").startsWith("other platform"));
  }
