...
/**
 * A generic integer parameter for a {@link ParameterSpecification} with 2 indexes.
 * 
 * <p>Stores the integer value as a {@code int}.
 */
public class TwoIndexIntParameter extends TwoIndexParameter {
   ...
   */
  public TwoIndexIntParameter(ParameterSpecification specification, int index1, int index2,
      int value) {
   ...
   * @throws IncorrectValueTypeException If the parameter value type is incorrect
   */
  public TwoIndexIntParameter(ProtocolSpecification specification, int index1, int index2,
      int value) {
    super(specification, index1, index2);
    ParameterUtils.compatibleValueType(REQUIRED, specification);
    this.value = value;
