...
/**
 * A generic text parameter for a {@link ParameterSpecification} with one index.
 */
public class OneIndexTextParameter extends OneIndexParameter {
   ...
   */
  public OneIndexTextParameter(ParameterSpecification specification, int index, String value) {
   ...
   * @throws IncorrectValueTypeException If the parameter value type is incorrect
   */
  public OneIndexTextParameter(ProtocolSpecification specification, int index, String value) {
    super(specification, index);
    ParameterUtils.compatibleValueType(REQUIRED, specification);
    this.value = Objects.requireNonNull(value, "Value");
  }
